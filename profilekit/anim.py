...
class Timeline:
    ...
    def hold(self, seconds):
        """Charge wall-clock seconds to the clock, ignoring the speed multiplier. Used for the
        deliberate pauses in the boot screen, where "five seconds" means five seconds."""
        if self.on:
